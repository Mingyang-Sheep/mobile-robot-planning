#ifndef MR_TRADITIONAL_PLANNER_OPTIMAL_THETA_STAR_PLANNER_H_
#define MR_TRADITIONAL_PLANNER_OPTIMAL_THETA_STAR_PLANNER_H_
...
class ThetaStarPlanner : public PlannerPlugin {
 public:
  ThetaStarPlanner();
 ...
 private:
  ...
  bool lineOfSight(int from_index, int to_x, int to_y) const;
...
#endif  // MR_TRADITIONAL_PLANNER_OPTIMAL_THETA_STAR_PLANNER_H_
